      ...
      <div className="no-scrollbar max-h-[90vh] w-full max-w-md overflow-y-auto rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-800">
        <div className="flex items-center gap-3 border-b border-gray-100 px-6 py-4 dark:border-gray-700">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="text-base font-bold text-gray-900 dark:text-gray-100">Approve &amp; Provide Money</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 px-6 py-5">
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Attach proof that you've handed the money over to the employee (photo, screenshot, receipt copy). Add
            more rows for multiple files.
          ...
          <div>
            <label className="mb-2 block text-sm font-semibold text-gray-700 dark:text-gray-300">
              ...
              {isCash && <span className="font-normal text-gray-400">(optional)</span>}
            </label>
            ...
            <p className={`mt-1.5 text-xs ${error ? "text-red-500" : "text-gray-400 dark:text-gray-500"}`}>
